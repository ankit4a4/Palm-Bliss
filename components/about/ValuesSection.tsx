...
const values = [
  ...
  },
  {
    ...
    images: [
      "/images/icon/natural1.jpg",
      "/images/icon/natural2.jpg",
      "/images/icon/natural3.jpg",
    ],
    images2: [
      "/images/icon/natural5.jpg",
      "/images/icon/natural4.jpg",
      "/images/icon/natural6.jpg",
    ]
  },
];
            ...
            <div className="bg-white/80 relative backdrop-blur-md border-none shadow-xl hover:shadow-2xl transition duration-300 rounded-2xl">
              <div className="p-8 relative">
                ...
                <div className="pl-12">
                  ...
                  <p className={`text-gray-600 leading-relaxed whitespace-pre-line ${index == 2 ? "pr-[120px]" : "pr-20"}`}>
                    {value.description}
                  </p>
                </div>
              </div>
